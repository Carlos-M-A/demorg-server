"""
Django settings for demorg project.
...
WSGI_APPLICATION = 'demorg.wsgi.application'
...
try:
    from demorg.local_settings import *
except ImportError:
    pass
